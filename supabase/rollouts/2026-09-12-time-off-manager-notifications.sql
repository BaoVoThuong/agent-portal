...
--
-- Lưu trên chính đơn, không tra lại lúc hiển thị: người đó có thể đổi vai trò
-- hoặc rời công ty, nhưng một đơn nộp tháng trước phải mãi mãi cho thấy nó đã
-- được gửi cho AI.
--
-- Hệ thống KHÔNG tự biết ai là quản lý của ai — người nộp tự chọn mỗi lần. Từng
-- có ý định dựng sơ đồ tổ chức để suy ra, nhưng đội đã bỏ hướng đó.
--
