...
| Enrollment option-field surface (Create/List/Detail) | Completed | `6b7ca86` | `npx tsc --noEmit`; targeted ESLint; `npx vitest run`; `git diff --check` | Removed nested Create badges, restored CS-style chevrons/menu spacing, and kept list badges/detail controls surface-specific |
