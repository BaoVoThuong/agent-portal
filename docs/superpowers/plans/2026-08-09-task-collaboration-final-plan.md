...
| 9. Attachment idempotency | C | P2 | Implemented | `TBD` | Attachment validation tests + typecheck passed | Multipart auth gate, sign-before-commit, atomic metadata/audit, idempotency replay, compensation, and warning-only side effects implemented. Live storage/DB fault injection pending. |
