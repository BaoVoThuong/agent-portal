...
| 5. Delete ordering | B | **P1** | Implemented | `TBD` | Typecheck passed | Metadata/audit commit now precedes best-effort storage cleanup; DB/storage fault injection pending. |
