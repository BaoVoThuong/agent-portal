...
**Task kế tiếp:** —
**Commit gần nhất (code):** `010cff3` fix(leads): harden schema, alert filters, and validation
...
| 17. Màn admin cho từ vựng | ✅ xong, 7 validator tests + full verification sạch | `cd7e7d0` + `010cff3` |
