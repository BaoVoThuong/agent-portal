...
import {
  POLICY_DETAIL_TABLE_MAX_HEIGHT,
  SALES_MOM_SCROLL_MAX_HEIGHT,
  TREND_LIMIT_BY_LEVEL,
...
} from "./AgentPcDashboard.types";

// Re-export các symbol công khai để giữ nguyên đường import của page.tsx.
export {
  UNPAID_PAID_DATE_LABEL,
  type AgentPcFilterOptions,
  type AgentPcFilterValues,
