export const PERMISSIONS = {
  ...
  ORG_CHART_VIEW: "people.org_chart_view",
  ORG_CHART_MANAGE: "people.org_chart_manage",
...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: PERMISSIONS.ORG_CHART_VIEW,
    label: "View Org Chart",
    groupKey: "people",
    groupLabel: "People",
    description: "View the organization chart and reporting lines.",
    sortOrder: 100,
  },
  {
    key: PERMISSIONS.ORG_CHART_MANAGE,
    label: "Manage Org Chart",
    groupKey: "people",
    groupLabel: "People",
    description: "Update reporting lines in the organization chart.",
    sortOrder: 200,
  },
  {
    key: PERMISSIONS.TIME_OFF_USER,
    label: "Time Off - User",
    groupKey: "time_off",
    groupLabel: "Time Off",
    description: "Request personal leave, view own requests, and see the shared availability calendar.",
    sortOrder: 100,
  },
  {
    key: PERMISSIONS.TIME_OFF_ADMIN,
    label: "Time Off - Admin",
    groupKey: "time_off",
    groupLabel: "Time Off",
    description: "Review team leave, manage balances, view leave history, and manage company days off.",
    sortOrder: 200,
  },
  {
