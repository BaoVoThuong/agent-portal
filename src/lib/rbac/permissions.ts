export const PERMISSIONS = {
  ...
  AGENT_PERFORMANCE_HEALTH_OWN: "agent_performance.health.own",
  AGENT_PERFORMANCE_HEALTH_ALL: "agent_performance.health.all",
  AGENT_PERFORMANCE_PC_OWN: "agent_performance.pc.own",
  AGENT_PERFORMANCE_PC_ALL: "agent_performance.pc.all",
  AGENT_PERFORMANCE_LIFE_OWN: "agent_performance.life.own",
  AGENT_PERFORMANCE_LIFE_ALL: "agent_performance.life.all",
  SALES_PERFORMANCE_ACCESS: "sales_performance.access",
...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_HEALTH_OWN,
    label: "Agent Health Performance - Own",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View the user's own Health agent performance data.",
    sortOrder: 100,
  },
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_HEALTH_ALL,
    label: "Agent Health Performance - All",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View Health agent performance data for all users.",
    sortOrder: 110,
  },
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_PC_OWN,
    label: "Agent P&C Performance - Own",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View the user's own P&C agent performance data.",
    sortOrder: 200,
  },
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_PC_ALL,
    label: "Agent P&C Performance - All",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View P&C agent performance data for all users.",
    sortOrder: 210,
  },
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_LIFE_OWN,
    label: "Agent Life Performance - Own",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View the user's own Life agent performance data.",
    sortOrder: 300,
  },
  {
    key: PERMISSIONS.AGENT_PERFORMANCE_LIFE_ALL,
    label: "Agent Life Performance - All",
    groupKey: "agent_performance",
    groupLabel: "Agent Performance",
    description: "View Life agent performance data for all users.",
    sortOrder: 310,
  },
  {
    key: PERMISSIONS.SALES_PERFORMANCE_ACCESS,
    label: "Sales Performance",
    groupKey: "sales_performance",
    groupLabel: "Sales Performance",
    description: "View all Sales Performance pages.",
    sortOrder: 100,
  },
  {
